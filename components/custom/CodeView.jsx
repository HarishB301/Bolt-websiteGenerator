...
const CodeView = () => {
  ...
  const UpdatedFiles = useMutation(api.workspace.UpdateFilesTo);
  const { id } = useParams();
  ...
  return (
    <div className="">
      ...
      <div
        className="p-10 bg-grey-900 opacity-80 absolute top-[300px] rounded-lg w-full flex
                  items-center justify-center pr-[200px]"
      >
        {loading && (
          <>
